...
You can download all the R scripts used in the slides [here](MBG/R scripts.zip).
...
-   [Exercise](MBG/Exercises/Exercise-1.pdf), [raster files](MBG/Data/Tanzania_rasters.zip) for the analysis and [solution](MBG/Exercises/Exercise 1 (solution).zip)
...
-   [Exercise](MBG/Exercises/Exercise-2.pdf) and [solution](MBG/Exercises/Exercise 2 (solution).zip)
...
-   [Exercise](MBG/Exercises/Exercise-3.pdf) and [solution](MBG/Exercises/Exercise 3 (solution).zip)
