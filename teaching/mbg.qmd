...
-   [Slides and R scripts](MBG/introduction.qmd)

### 2. Exploratory Analysis

Exploring regression relationships, overdispersion and spatial correlation.

-   [Slides and R scripts](MBG/exp_analysis.qmd)
-   [Exercise](MBG/Exercises/Exercise-1.pdf) and [raster files](MBG/Data/Tanzania_rasters.zip) for the analysis
...
-   [Slides and R scripts](MBG/estimation.qmd)
-   [Exercise](MBG/Exercises/Exercise-2.pdf)
